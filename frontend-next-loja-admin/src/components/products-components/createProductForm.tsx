...
import { genreCategories, initialState, productCategoriesByGenre } from './utils/product-definition';
                ...
                <div className="space-y-2">
                  ...
                  <Select name="genre"
                    ...
                    <SelectTrigger
                      ...
                      className={cn(categoryErrors && 'border-red-500', 'w-full')}
                    >
                ...
                <div className="space-y-2 ">
                  ...
                  >
                    <SelectTrigger
                      ...
                      className={cn('w-full', categoryErrors && 'border-red-500')}
                    >
                      <SelectValue placeholder={!selectedGenre ? "Selecione um gênero primeiro" : "Selecione uma categoria"} />
                    </SelectTrigger>
                    <SelectContent>
